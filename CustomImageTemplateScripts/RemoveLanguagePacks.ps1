...
function Get-RegionInfo($Name='*')
{
  try {
    ...
    Write-Host "*** AVD AIB CUSTOMIZER PHASE: Remove Language - Exception occurred while getting region information***"
...
Write-Host "*** Starting AVD AIB CUSTOMIZER PHASE: Remove Language ***"
...
try {
  ...
  Uninstall-Language $LanguageTag
} 
catch {
    Write-Host "*** AVD AIB CUSTOMIZER PHASE: Remove Language - Exception occurred***"
    Write-Host $PSItem.Exception
}
...
Write-Host "*** AVD AIB CUSTOMIZER PHASE: Remove Language - Exit Code: $LASTEXITCODE ***"
Write-Host "*** AVD AIB CUSTOMIZER PHASE: Remove Language - Time taken: $elapsedTime ***"
